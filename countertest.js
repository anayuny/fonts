    ...
    <div class="inside">
        <div class="stats-row">
            <div class="stat-block">
                <p><strong>설립년도</strong></p>
                <div class="icon">
                    <img src="https://cdn.imweb.me/upload/S2024090508a10653ec846/0ad4f27b40283.png" alt="date-of-establishment">
                </div>
                <div class="counter-container">
                    <div id="counter0" class="counter-value">0</div>
                    <p class="unit">년</p>
                </div>
            </div>
            <div class="divider"></div>
            <div class="stat-block">
                <p><strong>임직원</strong></p>
                <div class="icon">
                    <img src="https://cdn.imweb.me/upload/S2024090508a10653ec846/ba9a953af0315.png" alt="date-of-establishment">
                </div>
                <div class="counter-container">
                    <div id="counter1" class="counter-value">0</div>
                    <p class="unit">+</p>
                </div>
            </div>
            <div class="divider"></div>
            <div class="stat-block">
                <p><strong>R&D 지적재산권</strong></p>
                <div class="icon">
                    <img class="glowing-value" src="https://cdn.imweb.me/upload/S2024090508a10653ec846/e4b03bfb0f7e2.png" alt="date-of-establishment">
                </div>
                <div class="counter-container">
                    <div id="counter2" class="counter-value">0</div>
                    <p class="unit">+</p>
                </div>
            </div>
            <div class="divider"></div>
            <div class="stat-block">
                ...
                <div class="icon">
                    <img src="https://cdn.imweb.me/upload/S2024090508a10653ec846/fc3a61911f9fe.png" alt="date-of-establishment">
                </div>
                <div class="counter-container">
                    <div id="counter3" class="counter-value">0</div>
                    <p class="unit">억</p>
                </div>
            </div>
        </div>
